...
data class VolunteerDetailResult(
    ...
    val scheduleResultList: List<VolunteerScheduleResult>,
    val studentParticipationResultList: List<StudentParticipationResult>,
    val activityResultList: List<ActivityResult>,
    val userActivityResultList: List<UserActivityResult>
)

data class VolunteerScheduleResult(
    val scheduleId: UUID,
    val scheduleDate: LocalDate
)

data class StudentParticipationResult(
    val userId: UUID,
    val name: String,
