...
object FooterDrawer {
    ...
    fun draw(
        ...
        PdfDrawingUtils.drawTextCentered(cs, font, 10f, pageW,
            topY - cellH * DocumentLayout.footerLine1Ratio, confirmText)
        PdfDrawingUtils.drawTextCentered(cs, semiBoldFont, DocumentLayout.fontSizeFooter, pageW,
            topY - cellH * DocumentLayout.footerLine2Ratio, dateText)
        PdfDrawingUtils.drawTextCentered(cs, semiBoldFont, DocumentLayout.fontSizeFooter, pageW,
            topY - cellH * DocumentLayout.footerLine3Ratio, sigText)
    }
}
